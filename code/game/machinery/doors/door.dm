...
/obj/machinery/door/attackby(obj/item/I as obj, mob/user as mob)
	...
	if(istype(I, /obj/item/stack/material) && I.get_material_name() == src.get_material_name())
		...
		if(user.skillcheck(user.skills["engineering"], 75, 1, "I have failed to fix the door."))//Skill cehck.
			return
	...
	if(repairing && istype(I, /obj/item/weapon/weldingtool))
		if(!density)
			to_chat(user, "<span class='warning'>\The [src] must be closed before you can repair it.</span>")
			return
		if(!user.skillcheck(user.skills["engineering"], 75, 1))//Skill check.
			return
	...
	if(repairing && istype(I, /obj/item/weapon/crowbar))
		if(!user.skillcheck(user.skills["engineering"], 75, 1))//Skill cehck.
			return
